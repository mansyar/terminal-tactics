...
export const GameLayout: React.FC<GameLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen w-screen bg-matrix-bg flex flex-col landscape:flex-row md:flex-row p-4 gap-4 font-mono selection:bg-matrix-primary selection:text-matrix-bg">
      {/* MAIN TERMINAL AREA */}
